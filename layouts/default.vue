<template>
  <div class="min-h-screen bg-gradient-to-br from-teal-50 via-white to-cyan-50">
    ...
    >
      <aside
        v-if="sidebarOpen || !isMobile"
        class="fixed top-0 left-0 z-50 h-full w-72 bg-white/95 backdrop-blur-md shadow-2xl border-r border-white/20 lg:translate-x-0"
        :class="{ 'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen && isMobile }"
      >
        <!-- Sidebar Header -->
        <div class="flex items-center justify-between p-6 border-b border-gray-200/50">
          <NuxtLink to="/" class="flex items-center gap-3 group" @click="closeMobileSidebar">
            <div class="relative">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
          <div class="space-y-1">
            ...
            <NuxtLink
              ...
              class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-700 transition-all duration-200 relative overflow-hidden group"
              :class="$route.path === '/' ? 'bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-700 shadow-sm' : ''"
            >
              ...
              <div class="absolute right-2 w-2 h-2 bg-teal-500 rounded-full opacity-0 scale-0 transition-all duration-200"
                   :class="$route.path === '/' ? 'opacity-100 scale-100' : ''"></div>
            </NuxtLink>
            ...
            <div class="space-y-1">
              <NuxtLink
                ...
                @click="closeMobileSidebar"
                class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-700 transition-all duration-200 relative overflow-hidden group"
                :class="$route.path.startsWith('/appointments') ? 'bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-700 shadow-sm' : ''"
              >
                <div class="flex items-center justify-center w-8 h-8 rounded-lg bg-white/50 group-hover:bg-white/80 transition-all duration-200"
                ...
                <div class="absolute right-2 w-2 h-2 bg-teal-500 rounded-full opacity-0 scale-0 transition-all duration-200"
                     :class="$route.path.startsWith('/appointments') ? 'opacity-100 scale-100' : ''"></div>
              </NuxtLink>
              ...
              >
                <div v-if="$route.path.startsWith('/appointments')" class="ml-6 space-y-1 overflow-hidden">
                  <NuxtLink
                    to="/appointments/my"
                    @click="closeMobileSidebar"
            ...
            <NuxtLink
              ...
              @click="closeMobileSidebar"
              class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-700 transition-all duration-200 relative overflow-hidden group"
              :class="$route.path === '/calendar' ? 'bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-700 shadow-sm' : ''"
            >
              <div class="flex items-center justify-center w-8 h-8 rounded-lg bg-white/50 group-hover:bg-white/80 transition-all duration-200"
              ...
              <div class="absolute right-2 w-2 h-2 bg-teal-500 rounded-full opacity-0 scale-0 transition-all duration-200"
                   :class="$route.path === '/calendar' ? 'opacity-100 scale-100' : ''"></div>
            </NuxtLink>
            ...
            <NuxtLink
              ...
              @click="closeMobileSidebar"
              class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-700 transition-all duration-200 relative overflow-hidden group"
              :class="$route.path === '/patients' ? 'bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-700 shadow-sm' : ''"
            >
              <div class="flex items-center justify-center w-8 h-8 rounded-lg bg-white/50 group-hover:bg-white/80 transition-all duration-200"
              ...
              <div class="absolute right-2 w-2 h-2 bg-teal-500 rounded-full opacity-0 scale-0 transition-all duration-200"
                   :class="$route.path === '/patients' ? 'opacity-100 scale-100' : ''"></div>
            </NuxtLink>
            ...
            <NuxtLink
              ...
              @click="closeMobileSidebar"
              class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-700 transition-all duration-200 relative overflow-hidden group"
              :class="$route.path === '/reports' ? 'bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-700 shadow-sm' : ''"
            >
              <div class="flex items-center justify-center w-8 h-8 rounded-lg bg-white/50 group-hover:bg-white/80 transition-all duration-200"
              ...
              <div class="absolute right-2 w-2 h-2 bg-teal-500 rounded-full opacity-0 scale-0 transition-all duration-200"
                   :class="$route.path === '/reports' ? 'opacity-100 scale-100' : ''"></div>
            </NuxtLink>
            ...
            <NuxtLink
              ...
              @click="closeMobileSidebar"
              class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-700 transition-all duration-200 relative overflow-hidden group"
              :class="$route.path === '/settings' ? 'bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-700 shadow-sm' : ''"
            >
              <div class="flex items-center justify-center w-8 h-8 rounded-lg bg-white/50 group-hover:bg-white/80 transition-all duration-200"
              ...
              <div class="absolute right-2 w-2 h-2 bg-teal-500 rounded-full opacity-0 scale-0 transition-all duration-200"
                   :class="$route.path === '/settings' ? 'opacity-100 scale-100' : ''"></div>
            </NuxtLink>
          </div>
        </nav>
        ...
        <div class="border-t border-gray-200/50 p-4">
          <div class="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-teal-50 to-cyan-50 border border-teal-100">
